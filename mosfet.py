...
def pulse_buzzers():
    ...
    while True:  # Infinite loop
        ...
        # First "Another One" for buzzer 1 (GP10)
        print("Buzzer 1 (GP10) Another One")
        gate_pin_1.duty_u16(32768)  # 50% duty cycle for 0.2 seconds
        time.sleep(0.2)
        gate_pin_1.duty_u16(0)  # Turn off GP10

        # Second "Another One" for buzzer 1 (GP10)
        print("Buzzer 1 (GP10) Another One")
        gate_pin_1.duty_u16(32768)  # 50% duty cycle for 0.2 seconds
        time.sleep(0.2)
        gate_pin_1.duty_u16(0)  # Turn off GP10

        # Third "Another One" for buzzer 1 (GP10)
        print("Buzzer 1 (GP10) Another One")
        gate_pin_1.duty_u16(32768)  # 50% duty cycle for 0.2 seconds
        time.sleep(0.2)
        gate_pin_1.duty_u16(0)  # Turn off GP10
        ...
        # Start pattern: "Bites" for buzzer 2 (GP11)
        ...
        # Second "Bites" for buzzer 2 (GP11)
        print("Buzzer 2 (GP11) Bites")
        gate_pin_2.duty_u16(32768)  # 50% duty cycle for 0.1 seconds
        time.sleep(0.1)
        gate_pin_2.duty_u16(0)  # Turn off GP11
         # Third  "Bites" for buzzer 2 (GP11)
        print("Buzzer 2 (GP11) Bites")
        gate_pin_2.duty_u16(32768)  # 50% duty cycle for 0.1 seconds
        time.sleep(0.1)
        gate_pin_2.duty_u16(0)  # Turn off GP11
        ...
        # Start pattern: "The Dust" for buzzer 3 (GP12)
        ...
        # Second "Dust" for buzzer 3 (GP12)
        print("Buzzer 3 (GP12) Dust")
        gate_pin_3.duty_u16(32768)  # 50% duty cycle for 0.1 seconds
        time.sleep(0.1)
        gate_pin_3.duty_u16(0)  # Turn off GP12
         # 3 "Dust" for buzzer 3 (GP12)
        print("Buzzer 3 (GP12) Dust")
        gate_pin_3.duty_u16(32768)  # 50% duty cycle for 0.1 seconds
        time.sleep(0.1)
        gate_pin_3.duty_u16(0)  # Turn off GP12
